...
work_dir = '/data5/astjs/' #Was astjmack, but don't have permission
...
def loadparticles(run=default_run,tag=default_tag,model=default_model,directory=default_dir, mass_cut=[2e10,8e10]):
 ...
 boxsize = boxsize/h
 masstable = E.readAttribute("PARTDATA", sim, tag, "/Header/MassTable")
...
def halo(partstack,fofdat,simattributes,groupnum):
 ...
 print 'Isolating FoF %s and aligning....' %groupnum
